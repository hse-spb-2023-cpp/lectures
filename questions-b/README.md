...
* Своя реализация `std::vector`
    ...
    * Трудности с обеспечением базовой гарантии исключений при создании массива объектов (практика `25-240418`, задания `0*-minivector*`)
...
* Предусловия и постусловия конструктора и деструктора, инвариант объекта (`17-240206/01-exception-guarantees/10-raii.cpp`)
...
* Обеспечение базовой гарантии при помощи RAII (практика `17-240209`, задание `13-please-use-vector`)
...
`20-240229`, `21-240307`, `22-240314`, `23-240321`
...
* Cross-cast (он же side-cast, `14-240116/03-multiple-inheritance/10-side-cast.cpp`)
...
* CRTP (практика `14-240119/01-crtp`)
...
* Базовое использование `##` в макросах
  * Было: генерация случайных имён переменных/функций при помощи `__LINE__` (`exercises/15-240126/02-new-var`)
